...
names[which(names=='SISAL')]                       <- 'SISALv2 (Comas-Bru et al., 2020)'
names[which(names=='Oxford Lake Level Database')] <-  'Oxford Lake Level Database (Street-Perrott et al., 1989)'
names[which(names=='Liefert and Shuman, 2020')]    <- 'N.A. Lake Level Database (Liefert and Shuman, 2020)'
names[which(names=='Legacy Climate v1.0')]         <- 'Legacy Climate v1.0 (Herzschuh et al., 2022)'
names[which(names=='Mid-Latitude Holocene')]       <- 'Mid-Latitude Holocene (Routson et al., 2019)'
names[which(names=='wNA')]                         <- 'Western North America (Routson et al., 2021)'

pieData$source <- names
pieData %>% arrange(source)

pie <- ggplot(pieData,aes(x="", y=n, fill=source)) +
