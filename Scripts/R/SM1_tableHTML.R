...
tbl <- tibble(Region         = pullTsVariable(lipdTSO,'geo_ipccRegion'),
              ...
              AgeControlN    = pullTsVariable(lipdTSO,'chronData_agesN_12k'),
              AgeControlMax  = pullTsVariable(lipdTSO,'chronData_agesMaxGap_12k'),
...
outTbl <- reactable(tbl2,
 ...
 columns   = list(
  ...
  AgeControlN     = colDef(width=50, align = 'right', name='Age Control #',filterable=FALSE),
  AgeControlMax   = colDef(width=60, align = 'right', name='Max Age Control Gap',filterable=FALSE),
