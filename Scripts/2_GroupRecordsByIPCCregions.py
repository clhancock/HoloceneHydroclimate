...
proxyData    = pd.read_csv(gitHub+'DataSummary/proxyHC.csv')
...
ipccRegions = gpd.read_file(gitHub+'DataSummary/IPCC-WGI-reference-regions-v4_shapefile/IPCC-WGI-reference-regions-v4.shp')
#ipccRegions = ipccRegions.loc[(ipccRegions['Type'] != 'Ocean')] #Option to only get terrestrial regions
